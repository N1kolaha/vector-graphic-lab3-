...
struct Polygon : Figure {
    ...
    double y4;
    std::string fill;
    Polygon(double x_1, double y_1, double x_2, double y_2, double x_3, double y_3, double x_4, double y_4, std::string _fill, std::string _stroke) {
        x1 = x_1;
        y1 = y_1;
        x2 = x_2;
        y2 = y_2;
...
int main() {
    ...
    Polygon pol1(100, 0, 250, 0, 800, 450, 800, 750, "#75998D","black");

    Polygon pol2(0, 600, 0, 800, 800, 0,750, 0, "#C5AE7C","black");
